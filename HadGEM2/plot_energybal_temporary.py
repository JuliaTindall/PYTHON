...
fileout='/nfs/see-fs-02_users/earjcti/PYTHON/PLOTS/HadGEM2/plot_energybal/RF_albedo'+pliop2_expt+'-'+preind_expt+'_temporary.eps' 
plt.savefig(fileout, bbox_inches='tight')  
...
fileout='/nfs/see-fs-02_users/earjcti/PYTHON/PLOTS/HadGEM2/plot_energybal/RF_energybal'+pliop2_expt+'-'+preind_expt+'_temporary.eps' 
plt.savefig(fileout, bbox_inches='tight')  
fileout='/nfs/see-fs-02_users/earjcti/PYTHON/PLOTS/HadGEM2/plot_energybal/RF_energybal'+pliop2_expt+'-'+preind_expt+'_temporary.png' 
plt.savefig(fileout, bbox_inches='tight')  

plt.close()

filetext='/home/earjcti/PYTHON/PLOTS/HadGEM2/plot_energybal/RF_energybal'+pliop2_expt+'-'+preind_expt+'_temporary.tex'
f= open(filetext,"w+")
