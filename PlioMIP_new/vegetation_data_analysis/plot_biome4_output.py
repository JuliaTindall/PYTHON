...
def get_prism3_biomes():
    ...
    """
    fname = ('/uolstore/Research/a/hera1/earjcti/PRISM/prism3_pliocene/exp2_alternate/' + 
             'biome_veg_v1.2.nc')
    ...
    fname = ('/uolstore/Research/a/hera1/earjcti/PRISM/prism3_pliocene/BAS_Observ_BIOME.nc')
    cube = iris.load_cube(fname)
...
def check_seasonal_for_each_biome(biome_pi_cube_lowres, biome_prism3_cube_lowres,
    ...
    cubegrid = iris.load_cube('/uolstore/Research/a/see-fs-02_users/earjcti/PYTHON/PROGRAMS/CEMAC/PLIOMIP2/one_lev_one_deg.nc')
    ...
    plio_mmmT_cube = iris.load_cube('/uolstore/Research/a/hera1/earjcti/regridded/NearSurfaceTemperature_multimodelmean_month.nc','NearSurfaceTemperaturemean_plio') # load cube
    pi_mmmT_cube = iris.load_cube('/uolstore/Research/a/hera1/earjcti/regridded/NearSurfaceTemperature_multimodelmean_month.nc','NearSurfaceTemperaturemean_pi') # load cube
...
MODELNAME = 'IPSLCM6A' # BIOME4 -  MMM
#MODELNAME = 'xozzb'
ABS_ANOM = 'pi'
#FILESTART = '/uolstore/Research/a/see-fs-02_users/earjcti/BIOME4/biome4_pliomip2/'
#MODELNAME = ''
#ABS_ANOM = ''
if MODELNAME == 'BIOME4':
    midfname = MODELNAME
...
if ABS_ANOM == 'Abs':
    FILENAME = FILESTART + midfname + '/' + MODELNAME + '_biome4out_absolute.nc'
if ABS_ANOM == 'pi':
    FILENAME = FILESTART + midfname + '/' + MODELNAME + '_biome4out_pi.nc'
if ABS_ANOM == '':
