...
#    PLOT_SMC
#PURPOSE
#    This program will plot some anomaly data over the Middle East for
#    Matt Jones.  Initially it will just compare 9ka and modern.
#     
...
os.chdir("/nfs/hera1/earjcti/IDLPLOTS/AMAZON/GNIP/")
filename="Middle_east.nc"
f=Dataset(filename, mode='r')
f.dimensions
f.variables

# retrieving a variable
avg_d18o_mod = f.variables['annual average d18o'][:]
stdev_d18o_mod = f.variables['standard deviation - annual d18o'][:]

avg_temp_mod = f.variables['annual average temp'][:]
stdev_temp_mod = f.variables['standard deviation - annual temp'][:]

avg_precip_mod = f.variables['annual average precip'][:]
stdev_precip_mod = f.variables['standard deviation - annual precip'][:]
