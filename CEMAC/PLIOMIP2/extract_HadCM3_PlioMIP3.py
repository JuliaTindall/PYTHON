...
#
#  This will extract the fields in the PlioMIP2 format but using the
#  PlioMIP3 data
#
#
#
...
fileextra = {
		...
		"VERT.VEL. ON OCEAN HALF LEVELS  CM/S" : "o@pf",
                ...
                "SALINITY (OCEAN)       (PSU-35)/1000" : "o#pg"
	}
...
if linux_win=='w':
    ...
    filestart='/nfs/hera1/earjcti/um/'+expt+'/pg/'
