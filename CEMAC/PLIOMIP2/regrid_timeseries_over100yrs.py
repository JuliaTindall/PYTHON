...
#        # we need to convert it to days since reference time
        refdate = 'days since 1500-01-31 00:00:00'
        ...
        regridded_cube.coord('time').attributes = None
...
# of the model
    ...
    if modelname == 'MIROC4m':
        ...
        print(filename,exptnamein,fielduse,atm_ocn_ind.get(fieldnamein))
    ...
    if modelname == 'COSMOS':
        ...
        endyear = "2799"
        if linux_win == 'l':
            filename = '/nfs/b0164/Data/AWI/COSMOS/'
    ...
    if modelname == 'NorESM1-F' or modelname == 'NorESM-L':
        ...
        endyear="1200"
        fielduse = NorESM_FIELDS.get(fieldnamein,fieldnamein)
        filename = ('/nfs/b0164/Data/NorESM-L/NorESM-L_'+exptnamein+'_PSL_200yr.nc')
