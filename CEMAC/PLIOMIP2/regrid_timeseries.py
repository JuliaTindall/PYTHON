...
def get_noresm_400(fieldname):
    ...
    """
    cubeall = iris.load_cube(filename,  'Ocean surface temperature')
...
def regrid_data(fieldnamein, exptnamein):
    ...
    if linux_win == 'l':
        ...
        outstart = ('/nfs/hera1/earjcti/regridded/' + modelname +
                    ...
                    np.str(STARTYEAR) + '-' + np.str(ENDYEAR)+ '_')
...
exptnamein = ['E400']  # type E280 EOI400 or an HadCM3 name
STARTYEAR = 0
ENDYEAR = 100
