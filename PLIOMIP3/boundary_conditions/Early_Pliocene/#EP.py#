...
###############################################
def change_attributes(cube,filetype, field_name):
    """
   ...
   #         print('not found it',att)
    ...
    print(filetype)
    if (filetype == 'soil' or filetype == 'Lake' 
        or filetype == 'veg' or filetype == 'ice'):
        infofield =  'This is the PRISM4 Pliocene' + field_name + 'using the land sea mask as presented in Dowsett et al (2016), modified to represent an open Central American Seaway'
    else:
        infofield =  'This is the PRISM4 Pliocene' + field_name + 'as presented in Dowsett et al (2016), modified to represent an open Central American Seaway'
...
def get_ice_and_veg(lsmcube):
    ...
    change_attributes(newicecube,'ice',' icesheets ')
    ...
    change_attributes(newvegcube,'veg',' vegetation ')
...
def get_soils_and_lakes(lsmcube): 
    ...
    change_attributes(newsoilcube,'soil',' soils ')
    ...
    change_attributes(newlakecube,'Lake',' lakes ')
...
new_plio_topo = change_attributes(new_plio_topo,'topo',' topography ')
...
lsmcube = change_attributes(lsmcube,'lsm',' land sea mask ')
...
#print(new_plio_topo)
#print(new_plio_topo.attributes)
#print(lsmcube.attributes)
#print(icecube)
#print(icecube.attributes)
#print(vegcube.attributes)
print(soilscube.attributes)
#print(lakescube.attributes)
