...
def check_lsm(file_to_check, details, mask_ind):
    ...
    print(' ')
    print(details) 
    cubeLSM = iris.load_cube('LP_MinLSM_LSM_v1.0.nc')  # 0 sea 1 land
...
check_lsm('LP_MinLSM_topo_v1.0.nc','topography', 't')
check_lsm('LP_MinLSM_icemask_v1.0.nc','ice', 'm')
check_lsm('LP_MinLSM_mbiome_v1.0.nc','veg', 'm')
check_lsm('LP_MinLSM_soil_v1.0.nc','soil', 'm')
check_lsm('LP_MinLSM_lake_v1.0.nc','lake', 'm')
