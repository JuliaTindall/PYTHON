...
for expt in exptnames:
    if expt == 'xpsio':
        filename = '/home/earjcti/um/xpsio/spinup/seaice_area_' + expt + '_SH_1991_3000.tex'
    else:
...
for expt in exptnames:
    filestart = '/home/earjcti/um/' + expt + '/spinup/salinity_' + expt
    if expt == 'xpsio':
        filename = filestart + '_60.0S-90S_1991_3000.tex'
    else:
...
for expt in exptnames:
    ...
    if expt == 'xpsio':
        filename = filestart + '1991_3000_-65.txt'
    else:
