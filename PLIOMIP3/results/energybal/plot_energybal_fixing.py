...
# Julia 17/1/2025 adapted for PlioMIP3
...
def rf_zonal_enbal(exptname):
  ...
  # outgoing sw (clear sky flux)
   ...
   # outgoing lw  (toa)
    ...
    if exptname=='xqbwd' or exptname=='xqbwi':
    ...
    components=[mean_epsilon,mean_epsilon_cs,mean_alpha_clr,mean_alpha_oc,mean_mu_cld,mean_gamma_cld,mean_mu_clr,mean_gamma_clr,mean_cloud,H,meantemp,mean_sw_down,lat,mean_alpha,mean_mu,mean_gamma,mean_mu_oc,mean_gamma_oc,mean_A,mean_orog,t]
    return(components)
...
components=rf_zonal_enbal(plio_expt)
emis_plio=components[0]
emis_plio_cs=components[1]
...
fileout='/nfs/hera1/earjcti/um/' + plio_expt + '/avgplots/energybal/RF_albedo_'+plio_expt+'-'+preind_expt+'_' + str(yearstart) + '_' + str(yearend) + '_fixing.eps' 
plt.savefig(fileout, bbox_inches='tight')  
...
fileout='/nfs/hera1/earjcti/um/' + plio_expt + '/avgplots/energybal/RF_energybal'+plio_expt+'-'+preind_expt+'_' + str(yearstart) + '_' + str(yearend) + '_fixing.eps' 
plt.savefig(fileout, bbox_inches='tight')  
