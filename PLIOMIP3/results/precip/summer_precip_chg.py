...
def get_avg(jobid, startyear):
    ...
    for year in range(startyear, startyear+NYEARS):
        jncube = iris.load_cube('/uolstore/Research/a/hera1/earjcti/um/' + jobid + '/pcpd/' + 
                 jobid + 'a#pd' + str(year).zfill(9) + 'jn+.nc',field)
        jlcube = iris.load_cube('/uolstore/Research/a/hera1/earjcti/um/' + jobid + '/pcpd/' + 
                 jobid + 'a#pd' + str(year).zfill(9) + 'jl+.nc',field)
        agcube = iris.load_cube('/uolstore/Research/a/hera1/earjcti/um/' + jobid + '/pcpd/' + 
...
#        vals = np.arange(-8.0, 9.0, 1.0)
    ...
    plt.savefig('/uolstore/Research/a/hera1/earjcti/um/' + EXPT +  '/avgplots/jja_' + EXPT + '-' + CNTL + '_' + field + str(EXPT_STARTYEAR) + '-' + str(EXPT_STARTYEAR+NYEARS) +  '.eps')
    plt.savefig('/uolstore/Research/a/hera1/earjcti/um/' + EXPT +  '/avgplots/jja_' + EXPT + '-' + CNTL + '_' + field+ str(EXPT_STARTYEAR) + '-' + str(EXPT_STARTYEAR+NYEARS) + '.png')
    plt.close()
    ...
    if field == 'precip': # also plot percentage change
        ...
        plt.savefig('/uolstore/Research/a/hera1/earjcti/um/' + EXPT +  '/avgplots/jja_' + EXPT + '-' + CNTL + '_' + field+ str(EXPT_STARTYEAR) + '-' + str(EXPT_STARTYEAR+NYEARS) + '_ratio.png')
        ...
        plt.title(titlename, fontsize=10)
        plt.gca().coastlines()
        plt.savefig('/uolstore/Research/a/hera1/earjcti/um/' + EXPT +  '/avgplots/jja_' + EXPT + '-' + CNTL + '_' + field+ str(EXPT_STARTYEAR) + '-' + str(EXPT_STARTYEAR+NYEARS) + '_NAmerica.eps')
        plt.savefig('/uolstore/Research/a/hera1/earjcti/um/' + EXPT +  '/avgplots/jja_' + EXPT + '-' + CNTL + '_' + field+ str(EXPT_STARTYEAR) + '-' + str(EXPT_STARTYEAR+NYEARS) + '_NAmerica.png')
        plt.close()
