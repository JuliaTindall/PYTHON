...
def plot_seaice(hemisphere,cube,month,lsm_cube):
    ...
    plt.savefig(outstart + expt + '_' + month + hemisphere + '_seaicearea_2_22.png')
    plt.savefig(outstart + expt + '_' + month + hemisphere + '_seaicearea_2_22.eps')
    plt.close()
...
def plot_seaice_anom(hemisphere,cubeexpt,cubecntl,month,lsm_cube):
    ...
    iplt.contour(lsm_cube, levels=[-2,0.5,2],
                  colors='black', linewidths=0.1)
    plt.savefig(outstart + expt + '-' +  cntl + '_' + month + hemisphere + '_seaice_2_22.png')
    plt.savefig(outstart + expt + '-' + cntl + '_' + month + hemisphere + '_seaice_2_22.eps')
    plt.close()
...
MP_cube = iris.load_cube(filestart + 'um/'+expt+'/database_averages/'+expt+'_Monthly_Average_#pf_SeaIceConc_2_22.nc', 'SeaIceConc')
PI_cube = iris.load_cube(filestart + 'um/'+cntl+'/database_averages/'+cntl+'_Monthly_Average_#pf_SeaIceConc_2_22.nc', 'SeaIceConc')
