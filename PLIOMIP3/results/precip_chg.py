...
#        vals = np.arange(-8.0, 9.0, 1.0)
    ...
    plt.savefig('/nfs/hera1/earjcti/um/' + EXPT +  '/avgplots/' + EXPT + '-' + CNTL + '_' + field + str(EXPT_STARTYEAR) + '-' + str(EXPT_STARTYEAR+NYEARS) +  '.eps')
    plt.savefig('/nfs/hera1/earjcti/um/' + EXPT +  '/avgplots/' + EXPT + '-' + CNTL + '_' + field+ str(EXPT_STARTYEAR) + '-' + str(EXPT_STARTYEAR+NYEARS) + '.png')
    plt.close()
    ...
    if field == 'precip': # also plot percentage change
        ...
        print('about to write to file')
        plt.savefig('/nfs/hera1/earjcti/um/' + EXPT +  '/avgplots/' + EXPT + '-' + CNTL + '_' + field+ str(EXPT_STARTYEAR) + '-' + str(EXPT_STARTYEAR+NYEARS) + '_ratio.eps')
        plt.savefig('/nfs/hera1/earjcti/um/' + EXPT +  '/avgplots/' + EXPT + '-' + CNTL + '_' + field+ str(EXPT_STARTYEAR) + '-' + str(EXPT_STARTYEAR+NYEARS) + '_ratio.png')
