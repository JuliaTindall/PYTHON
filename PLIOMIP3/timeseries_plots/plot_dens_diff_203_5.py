#python program
#
# this program will plot the timeseries of the density difference between 666m and 5m.  The file used was created by:  spinup/and/timeseries/density_gradients.py
...
for expt in exptnames:
    ...
    if expt == 'xpsie':
        ...
        plt.plot(x_mean, y_mean, label=period.get(expt) )
    plt.title('density 203m-density 5m')
...
plt.savefig('dens_diff_203_5_30yr.png')
