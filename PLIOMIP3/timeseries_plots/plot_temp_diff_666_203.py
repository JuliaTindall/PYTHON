#python program
#
# this program will plot the timeseries of the temperature difference between 666m and 204m.  The file used was created by:  spinup/and/timeseries/temperature_gradients.py
...
for expt in exptnames:
    ...
    if expt == 'xpsie':
        ...
        plt.plot(x_mean, y_mean, label=period.get(expt) )
    plt.title('temperature 666m-temperature 203m')
...
plt.savefig('temp_diff_666_203_30yr.png')
