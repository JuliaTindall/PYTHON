...
def get_shell_cube():
    ...
    if field == 'precip' or field == 'precip_1':
       filename = ('/nfs/hera1/earjcti/um/xqbwc/database_averages/' + 
           'xqbwc_Monthly_Average_#pd_TotalPrecipitationRate_3900_4000.nc')
...
# this function will extract the data and write out to a file
    ...
    for year in range(startyear,endyear):
        print(year)
        # get a year of field(ie 360 days)
...
# there is also 'precip' and 'precip_1'.  precip is much higher than precip_1. 
#  I think that the one we want is precip_1 and that precip is the maximum
