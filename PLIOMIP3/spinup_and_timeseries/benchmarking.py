...
# our climate runs are significantly different at various times in the 
# simulation.  
#  We are doing this to see how well the climate is spun up.
#
#NOTES
#  what is a t-test
...
class main():
    ...
    def __init__(self, field):
        ...
        if LINUX_WIN == 'w':
            ...
            startout = "/nfs/see-fs-02_users/earjcti/PYTHON/PLOTS/PLIOMIP3/assess_spinup/benchmarking/"
            if EXPT_TYPE == 'S':
