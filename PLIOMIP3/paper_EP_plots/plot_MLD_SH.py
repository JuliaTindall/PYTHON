...
allyears= ['0000014','0000020']  # 1400-1500 and 2000-210
titles = ['1400 - 1500','2000 - 2100']
fig = ['a)','b)']
expt = 'xpsie'
...
for i,years in enumerate(allyears):
    mld=all_mld[i].where(mld > 0)
    ...
    plt.title(fig[i] + ' MLD : ' +  titles[i],fontsize=16)


# plot anomaly
vals = np.arange(-50,55,5)
...
cbar.ax.tick_params(labelsize=12)
cbar.ax.set_title('metres', fontsize=14)
plt.title('c) MLD anomaly',fontsize=16)
