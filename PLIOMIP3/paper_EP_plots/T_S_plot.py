...
# read in data
fileg_Atl = (filestart +
             'xqbwg/basin_diagnostics/T_S_mean_xqbwg_Atlantic3901_3999.nc')
filej_Atl = (filestart +
             'xqbwj/basin_diagnostics/T_S_mean_xqbwj_Atlantic3901_3999.nc')
fileg_Pac = (filestart +
             'xqbwg/basin_diagnostics/T_S_mean_xqbwg_Indo_Pacific3901_3999.nc')
filej_Pac = (filestart +
             'xqbwj/basin_diagnostics/T_S_mean_xqbwj_Indo_Pacific3901_3999.nc')
