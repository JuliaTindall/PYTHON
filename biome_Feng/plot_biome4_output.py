...
def plot_biomes(names, rgbdata, biomecube, cmap, norm, V,):
    ...
    if MODELNAME == 'BIOME4':
        midfname = MODELNAME + '/' + MODELNAME + '_'
    elif MODELNAME == 'BIOME4_NEWPARAMETERS':
        midfname = 'BIOME4/' + MODELNAME + '/' + MODELNAME + '_'
    else:
        midfname =  MODELNAME + '/biome4/' + MODELNAME + '_'
...
#FILESTART = '/home/earjcti/BIOME4-main/out_tdlvb.nc'
FILESTART = '/home/earjcti/umdata/'
MODELNAME = '' # BIOME4 -  MMM
MODELNAME = 'xlotj'
ABS_ANOM = 'Anom'
